...
{
    myStruct *sample = NULL;

    sample = new (std::nothrow) myStruct ;
    if (sample == NULL) {
        return NULL;
    }

    if (!myStruct_initialize_w_params(sample,alloc_params)) {
        delete  sample;
        sample=NULL;
    }
    return sample; 
...
myStructPluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!myStruct_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        delete  sample;
        sample=NULL;
    }
...
{
    return myStructPluginSupport_create_data_ex(RTI_TRUE);
}
...
myStructPluginSupport_destroy_data_w_params(
    ...
    myStruct_finalize_w_params(sample,dealloc_params);
...
myStructPluginSupport_destroy_data_ex(
    ...
    myStruct_finalize_ex(sample,deallocate_pointers);
...
myStructPluginSupport_destroy_data(
    ...
    myStructPluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
myStructPluginSupport_copy_data(
    ...
    const myStruct *src)
{
    return myStruct_copy(dst,(const myStruct*) src);
}
    ...
    unsigned int indent_level)
{
    ...
    RTICdrType_printLong(
        &sample->seqId, "seqId", indent_level + 1);    
    ...
    void *handle)
{
    ...
    myStruct_finalize_optional_members(sample, RTI_TRUE);
    ...
    void *endpoint_plugin_qos)
{
    ...
    try {
        ...
        if(deserialize_sample) {
            ...
            myStruct_initialize_ex(sample, RTI_FALSE, RTI_FALSE);
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!myStructPlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
...
{ 
    ...
    myStruct_finalize_optional_members;
    ...
    */
    ...
    plugin->typeCode =  (struct RTICdrTypeCode *)myStruct_get_typecode();
    ...
    plugin->endpointTypeName = myStructTYPENAME;
